...
import com.capgemini.forestrymanagement.hibernatedao.LandDao;
import com.capgemini.forestrymanagement.hibernatemanager.LandDaoManager;

public class Land {
	public static void land() {
		LandDao dao = LandDaoManager.getContractordao();
		...
		try {
			while (true) {
				...
				case 3:
					...
					boolean check3 = dao.modifyLand(bean, landNo1);
					if (check3) {
