...
public class ProductDAOImpl implements ProductDAO {
	...
	public boolean updateProduct(ProductBean productBean) {
		try {
			...
			query.setParameter("pclass", productBean.getProductClass());
			query.setParameter("quantity", productBean.getQantity());
			query.setParameter("cost", productBean.getCost());
			query.setParameter("pid", productBean.getPID());
