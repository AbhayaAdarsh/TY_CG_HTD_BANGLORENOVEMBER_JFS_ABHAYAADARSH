package com.capgemini.springrestforestrymanagement.validation;
...
public class Validations {
	public static boolean fullNameValidation(String fullName) {
		...
		if (namematcher.matches()) {
			...
			throw new ValidationException("please Enter the VALID NAME..!");
		}
	}
	...
	public static boolean alphabetsValidation(String alphabets) {
		...
		if (alphabetsmatcher.matches()) {
			...
			throw new ValidationException("please Enter the Valid Input, Must Be Alphabets..!");
		}
	}
	...
	public static boolean emailValidation(String email) {
		...
		if (emailmatcher.matches()) {
			...
			throw new ValidationException("Please Enter The Valid Email-Id");
		}
	}
	...
	public static boolean numberValidation(int number1) {
		...
		if (numbermatcher.matches()) {
			...
			throw new ValidationException("Please Enter The Valid Input, Must be Number..!");
		}
	}
	...
	public static boolean phoneNumberValidation(String phone) {
		...
		if (phonematcher.matches()) {
			...
			throw new ValidationException("Please Enter 10-Digit Valid Phone Number..!");
		}
	}
	...
	public static boolean haulierIdVallidation(String haulier) {
		...
		if (hauliermatcher.matches()) {
			...
			throw new ValidationException("please Enter The Vallid HualuerId");
		}
	}
	...
	public static boolean postalValidation(int postal) {
		...
		if (numbermatcher.matches()) {
			...
			throw new ValidationException("Please Enter The Valid Input, Must be Number And Length Should Be 6..!");
		}
	}
