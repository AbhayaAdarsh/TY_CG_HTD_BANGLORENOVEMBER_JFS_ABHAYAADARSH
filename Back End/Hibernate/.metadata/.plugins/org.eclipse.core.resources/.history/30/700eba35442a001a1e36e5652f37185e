...
public class TestManyToMany {
	public static void main(String args[]) {
		...
		empInfo.setempid(37);//setting the value for data fields
		empInfo.setempname("Arun");
		empInfo.setEmail("ar@gmail.com");
		empInfo.setPassword("123345");
		
		EmployeeInfo empInfo1 =  new EmployeeInfo();
		empInfo1.setempid(91);//setting the value for data fields
		empInfo1.setempname("Anika");
